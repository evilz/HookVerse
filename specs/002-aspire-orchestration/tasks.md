...
- [X] T173 Create DEPLOYMENT.md documenting manifest generation and deployment process
- [X] T174 Update API-GUIDE.md with service discovery patterns
- [X] T175 Document observability configuration in docs/observability.md
- [X] T176 Create troubleshooting guide in docs/troubleshooting-aspire.md
...
- [X] T183 Perform end-to-end smoke test: start locally → make code change → deploy to staging
